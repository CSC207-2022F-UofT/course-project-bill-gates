...
public class Main {
    ...
    public static void main(String[] args){
        ...
        mainFrame.setBillImportController(initBillImportUseCase(databaseGateway));
    ...
    public static BillImportController initBillImportUseCase(DatabaseGateway databaseGateway){
