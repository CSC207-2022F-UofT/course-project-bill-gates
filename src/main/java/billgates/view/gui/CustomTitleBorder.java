...
public class CustomTitleBorder extends TitledBorder{
    ...
    public static final Border EMPTY_BORDER = BorderFactory.createEmptyBorder(DEFAULT_EMPTY_BORDER_THICKNESS,
            DEFAULT_EMPTY_BORDER_THICKNESS, DEFAULT_EMPTY_BORDER_THICKNESS, DEFAULT_EMPTY_BORDER_THICKNESS);

    public static final Border OUTSIDE_BORDER = BorderFactory.createCompoundBorder(EMPTY_BORDER, LINE_BORDER);
